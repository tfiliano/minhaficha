...
const printersTableContainer = document.getElementById(
...
const confirmDeletePrinterBtn = document.getElementById(
        ...
        row.innerHTML = `
          ...
          <td class="actions">
            <button class="btn btn-sm ${
              isOnline ? "btn-success" : "btn-warning"
      ...
      for (const job of queue) {
        ...
        row.innerHTML = `
          ...
          <td>
            ...
            ${
              job.error_message
                ? `<div class="timestamp">${job.error_message}</div>`
                : ""
            }
          </td>
          <td>
    ...
    const html = `
      <div class="job-details-section">
        ...
        <div class="job-details-row">
          ...
          <div class="job-details-value">${
            job.impressoras?.nome || "Desconhecida"
          }</div>
        </div>
        <div class="job-details-row">
      ...
      <div class="job-details-section">
        ...
        <div class="job-command">${
          job.command || "Nenhum comando disponível"
        }</div>
      </div>
    `;
      ...
      <div class="job-details-section">
        ...
        <div style="text-align: center; margin: 20px 0;">
          <img src="data:image/png;base64,${
            preview.imageData
          }" alt="Preview da etiqueta" style="max-width: 100%; border: 1px solid #ccc;" />
        </div>
      </div>
...
const printerSelectionLoading = document.getElementById(
  "printer-selection-loading"
);
const printerSelectionError = document.getElementById(
  "printer-selection-error"
);
const printerSelectionContainer = document.getElementById(
  "printer-selection-container"
);
const printerSelection = document.getElementById("printer-selection");
const confirmChangePrinterBtn = document.getElementById(
  "confirm-change-printer"
);
...
window.enableTestMode = () => {
  ...
  alert(
    "Modo de teste ativado! As impressões serão processadas em um ambiente simulado."
  );
  location.reload();
};
