...
export default function EntradasInsumosReportPage() {
  ...
  const handleExportReport = async () => {
    ...
    startTransition(async () => {
      try {
        const response = await fetch("/api/reports/analiticos/entradas-insumos/excel", {
          method: "POST",
          headers: {
        ...
        link.href = url;
        link.download = `relatorio_entradas_insumos_${format(date.from!, "dd-MM-yyyy")}_${format(date.to!, "dd-MM-yyyy")}.xlsx`;
  ...
  return (
    <div className="container mx-auto p-4">
      <Title>Relatório de Entradas de Insumos</Title>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Selecione o período e exporte os dados de entradas de insumos
              </p>
            </div>
          </div>
