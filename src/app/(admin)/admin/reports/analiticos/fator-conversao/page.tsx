...
export default function FatorConversaoReportPage() {
  ...
  const handleExportReport = async () => {
    ...
    startTransition(async () => {
      try {
        const response = await fetch("/api/reports/analiticos/fator-conversao/excel", {
          method: "POST",
          headers: {
        ...
        link.href = url;
        link.download = `relatorio_fator_conversao_${format(date.from!, "dd-MM-yyyy")}_${format(date.to!, "dd-MM-yyyy")}.xlsx`;
  ...
  return (
    <div className="container mx-auto p-4">
      <Title>Relatório de Fator de Conversão</Title>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Selecione o período e exporte os dados de fator de conversão
              </p>
            </div>
          </div>
