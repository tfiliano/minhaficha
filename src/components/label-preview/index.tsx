      ...
      .forEach((field, index) => {
        ...
        if (selectedFieldIndex === index) {
          ...
          if (field.fieldType === "line") {
            ...
            ctx.font = `${field.fontStyle === "bold" ? "bold" : "normal"} ${
          ...
          ctx.strokeRect(
            selectionX - 2,
            selectionY -
              (field.fieldType === "dynamic" || field.fieldType === "static"
                ? field.fontSize * scale * 0.8
                : 2),
            selectionWidth + 4,
            selectionHeight + 4
          );
          ...
          // 4 cantos
          ctx.fillRect(
            selectionX - handleSize / 2,
            selectionY - handleSize / 2,
            handleSize,
            handleSize
          );
          ctx.fillRect(
            selectionX + selectionWidth - handleSize / 2,
            selectionY - handleSize / 2,
            handleSize,
            handleSize
          );
          ctx.fillRect(
            selectionX - handleSize / 2,
            selectionY + selectionHeight - handleSize / 2,
            handleSize,
            handleSize
          );
          ctx.fillRect(
        ...
        switch (field.fieldType) {
          ...
          case "static": {
            ...
            ctx.fillText(
              content,
              xPos,
              (field.y + field.fontSize * 0.3) * scale
            );
            break;
          }
          ...
          case "line": {
            ...
            ctx.lineTo(
              (field.x + (field.lineWidth || 100)) * scale,
              field.y * scale
            );
            ctx.stroke();
            break;
          ...
          case "qrcode": {
            ...
            ctx.fillText(
              content,
              field.x * scale + qrSize / 2,
              field.y * scale + qrSize + 12 * scale
            );
            break;
          }
        }
